...
class Page extends Think {
  ...
  public function __construct($totalRows,$listRows,$p='') {
	...
	public function  show(){
		...
		$output = '';
		$output .= '<a class="a1_page">'.$this->totalRows.L('page_item').'</a>';
		$output .= '<a class="first_page" onclick="'.$this->pageurl($urlrule, 1,$this->parameter).'" href="'.$this->pageurl($urlrule, 1,$this->parameter).'">'.L('first_page').'</a>';
		...
		$output .='<a class="Last_page" href="'.$this->pageurl($urlrule,$this->totalPages,$this->parameter).'">'.L('Last_page')."</a>";
		return $output;
	}
	...
	public function  showUrl(){
		...
		$urlArr['prev'] = $this->pageurl($urlrule, $pre_page,$this->parameter);
		
		
		$urlArr['next'] = $this->pageurl($urlrule,$next_page,$this->parameter); 
