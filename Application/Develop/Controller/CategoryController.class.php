...
class CategoryController extends DevelopbaseController {
...
<a class="btn btn-danger btn-xs" href="javascript:confirm_delete(\''.U('category/delete',array( 'id' => $r['id'])).'\')">'.L('delete').'</a> ';
      ...
      $str = "<tr \$class_id class='\$class_css'>
          ...
          <td>\$id
            ...
            <input class='parentid' name='parentid' type='hidden' value='\$parentid'>
          </td>
          <td>
  ...
  function getTemplates()
  {
    ...
    $path= './Themes/Home/'.$sysConfig['DEFAULT_THEME'].'/';

    $templates = template_file('',$path);
