...
class SlideController extends DevelopbaseController {

  protected  $Tplpath,$Flashpath,$Xmlpath;

  function _initialize() {
    parent::_initialize();
    $this->Tplpath = '/Themes/Home/'.$this->sysConfig['DEFAULT_THEME'].'/';
    $this->Xmlpath = '/Themes/Home/'.$this->sysConfig['DEFAULT_THEME'].'/public/xml/';
  }
