...
use Org\Util\Page;
use Org\Util\Tree;
class DevelopbaseController extends Controller {
  ...
  function _initialize() {
    ...
    if(APP_LANG){
      ...
      }elseif(empty($_SESSION['ww_lang']) || empty($_SESSION['ww_langid'])){
  ...
  public function create_index($sitemap) {
    ...
    if(empty($sitemap)){
      ...
      $r=$this->buildHtml('sitemap', './'.$lang, 'sitemap');
    }
    if($r) return true;
  }
