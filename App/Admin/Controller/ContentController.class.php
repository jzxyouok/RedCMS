...
class ContentController extends AdminController {
    ...
    {
        $template = file_exists(MODULE_PATH.'View/Defalut/'.CONTROLLER_NAME.'/index.html') ? CONTROLLER_NAME.':index' : 'Content:index';
    ...
    public function add()
    {
        ...
        $template = file_exists(MODULE_PATH.CONTROLLER_NAME.'/edit.html') ? CONTROLLER_NAME.':edit' : 'Content:edit';
